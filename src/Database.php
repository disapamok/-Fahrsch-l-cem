...
class Database {
    ...
    public function get() {
      ...
      public function getArray() {
        ...
        return $this->getResultsArray("SELECT {$this->getFields()} FROM {$this->tableName} WHERE {$this->getConditions()}{$this->order}{$this->limit}{$this->groupBy}");
    }
    ...
    public function getResultsArray($query) {
        $rows = array();
        $result = $this->conn->query($query);
        if($result) {
